...
Nobel et al~\cite{Nobel2023,Boyd2024} subsequently refined these
...
constraints~\cite{Knuth2022,Vanderstraeten2018}---column non-repetition costs one unit
...
temperature~\cite{Zhang2009,Polson2024,Reynolds2019} and perform extensive Monte
...
places exactly $N$ queens---and use Kawasaki dynamics~\cite{Kawasaki1966,Frowis2010}
...
precisely encoded using the matrix product operator (MPO) formalism~\cite{Frowis2010,Verstraete2022}.
...
problems~\cite{Kourtis2019,Vanderstraeten2018,Tanaka2023}, of which the $N$-queens problem is a
natural instance.
