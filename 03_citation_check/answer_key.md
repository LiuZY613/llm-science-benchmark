# Answer Key — 8 处引用错误（评分基线）

**模型在 benchmark 中不可见**。本文件用于自动 / 人工评分。

源文件：`paper_buggy.tex`（基于 `eassy/eassy_v3.tex`，作者已人工核过的 18 条真实引用 + 8 处人为注入错误）。
...
- **真实信息**：Frowis, Nebendahl, Dür, Phys. Rev. A **81**, 062337 (2010) — DOI 10.1103/PhysRevA.81.062337
